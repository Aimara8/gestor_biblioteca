...
const headers = [
  ...
  { text: 'Title', value: 'titulo', align: 'start' },
  { text: 'Author', value: 'autor', align: 'start' },
  { text: 'Genre', value: 'genero', align: 'start' },
  { text: 'Publisher', value: 'editorial', align: 'start' },
  { text: 'Publication Year', value: 'fecha_publicacion', align: 'center', width: '150px' },
    ...
    <v-container fluid class="pa-6">
      <v-card flat class="rounded-lg">
        ...
        <v-card-text class="pa-0">
          <v-data-table :headers="headers" :items="librosList" :items-per-page="10" :hover="true" class="elevation-1"
            :footer-props="{
